...
import rasterio
import os
from src_v2.model_v2_7 import V2Autoencoder  # <--- UPDATED IMPORT
from src_v2.utils_v2 import pack_indices, rle_encode
from src_v2.overlap_utils import compute_tile_grid
...
def main(args):
    ...
    # Handle V2.7 vs V2.6 key difference
    if "model" in ckpt:
        state_dict = ckpt["model"] # V2.7
    else:
        state_dict = ckpt["model_state_dict"] # V2.6
