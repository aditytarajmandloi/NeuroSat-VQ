...
import pickle
import rasterio
from src_v2.model_v2_7 import V2Autoencoder, LATENT_CHANNELS, SLICE_DIM
...
def main(args):
    ...
    # Handle V2.7 vs V2.6 naming difference
    if "model" in ckpt:
        state_dict = ckpt["model"]        # V2.7 Key
    else:
        state_dict = ckpt["model_state_dict"] # V2.6 Key
